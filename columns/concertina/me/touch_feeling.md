...
この価格帯のものは外観こそコンサティーナですが、内部構造が良いコンサティーナと比べて簡略化されているものが多いため、弾きにくく、楽器としての寿命も短いものが多いです。
...
セッションでどんな曲でも快適に弾きたいならば、このラインが初心者の最低ラインだと思います。
...
初めに、APJを上位モデルとするには少々迷った。
というのは、そのままの状態で演奏するには少し不具合が生じる可能性があるからだ。
しかし、内部構造はかなりしっかりしており[[4]]、ちゃんと自分で微調整すれば化けるだけのポテンシャルがあるので上位モデルとした。
...
このような調整を施した後のAPJの評価は音色: 8, 操作感: 8である。
...
### [A.C. Norman & Co.](http://www.acnorman.co.uk/)
- アコーディオンリード
- 配列: Lachenal
- 操作感: 9/10
- 音色: 9/10
- 備考: 20年前、Claremanとして20万円で買ったと聞いた。

私はClaremanを2020年の秋に名古屋のセッションで弾かせてもらったことがある。
