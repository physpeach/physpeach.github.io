...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
end:/$/}]})})());hljs.registerLanguage("d",(()=>{"use strict";return e=>{const a={
...
begin:"@[a-zA-Z_][a-zA-Z_\\d]*"}]}}})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
end:"\\)"}]},{className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("javascript",(()=>{"use strict"
